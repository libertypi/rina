...
class Scraper(unittest.TestCase):
        ...
        values = {
            ...
            'SMbd-110 s 2 model 3':
                ('javbus.com', 'SMBD-110',
                 ...
                 1412985600),
            'bouga012 [cd2]': ('javbus.com', 'bouga012-2',
                               '忘我素人パイパンおさな妻浣腸2穴依頼調教', 1496275200),
    ...
    def test_h4610(self):
        values = {
            'H4610 gol185': ('h4610.com', 'H4610-gol185', '葉月 美加子', 1497052800),
            'C0930-gol0136':
                ('c0930.com', 'C0930-gol0136', '羽田 まなみ', 1456358400),
            'H0930 (ori1575)':
                ('h0930.com', 'H0930-ori1575', '吉間 智保', 1593216000)
        }
        self._run_test(values)
    ...
    def test_fc2(self):
        values = {
            'fc2-340671':
                ('fc2.com', 'FC2-340671',
                 '【激シコ美人】かわいくてエロくてマン汁たっぷりのゆうこ18歳にたっぷり中出し', 1542585600),
            'FC2-PPV-1380738_3': (
    ...
    def test_date(self):
        values = {
            ...
            'deeper.20.03.14.rae.lil.black':
                ('date string', None, None, 1584144000),
    ...
    def test_seesaawiki(self):
        ...
        values = {
            ...
            '成宮はるあ': ('乃木はるか', '1992-07-30', {
                '一ノ木ありさ', '深山梢', '乃木はるか', '葵律', '芦原亮子', '春宮はるな', '東美奈', '成宮はるあ',
                '陽咲希美'
            })
        }
        self._run_test(wiki, values)
    ...
    def test_msin(self):
        ...
        values = {
            ...
            '今村ゆう': ('沖野るり', '1996-03-15', {
                '有吉めぐみ', '吾妻絵里', '野本カノ', '生駒なお', '夏目陽菜', '沖野るり', '今村ゆう', '笠原佐智子'
            }),
