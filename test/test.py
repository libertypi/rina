...
class Scraper(unittest.TestCase):
    ...
    def test_javdb(self):
        values = (
            ("FC2PPV 1201745", ("javdb.com", "FC2-1201745", "シルクストッキングをテストするために女の子を雇います。", 1573776000.0)),
            (
                "XXXAV 20879",
    ...
    def test_heyzo(self):
        values = (
            ...
            ("heyzo 0706", ("heyzo.com", "HEYZO-0706", "鈴木さとみのイカセ方～ザーメンまみれのエロボディ～", 1413504000.0)),
        )
        self._run_test(values)
    ...
    def test_h4610(self):
        values = (
            ...
            ("C0930-gol0136", ("c0930.com", "C0930-gol0136", "羽田 まなみ", 1456358400)),
            ("H0930 (ori1575)", ("h0930.com", "H0930-ori1575", "吉間 智保", 1593216000)),
        )
        self._run_test(values)
